...
impl interactive_world::otto::plugin::types::Host for InteractiveHostState {}
...
impl WasmScreen {
    ...
    async fn new(
        ...
        let wit_args = interactive_world::exports::otto::plugin::screens::ScreenArgs {
            invocation_json,
...
mod tests {
    use super::*;
    use otto_plugin::{KeyCodePortable, KeyMods};
