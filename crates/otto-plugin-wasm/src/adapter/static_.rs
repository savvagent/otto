...
//! a `Box<dyn otto_plugin::Plugin>` to the runtime.
//!
//! ## Concurrency model
//!
...
use otto_plugin::manifest::Manifest;
use otto_plugin::{Effect, HostEvent, Plugin, PluginError, Region, StyledLine, ThemeEntry};
...
impl static_world::otto::plugin::types::Host for StaticHostState {}
...
/// provide) so the wire shape is stable across otto versions.
