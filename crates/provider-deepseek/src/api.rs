//! Typed DeepSeek Chat Completions request and response shapes.
//!
//! Only the subset SPP needs is modeled. Field names follow DeepSeek's
...
pub struct DeltaToolCall {
    /// Index within the parallel tool-calls array. DeepSeek uses this to
