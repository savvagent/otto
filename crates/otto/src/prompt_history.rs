...
//!
//! Submitted prompts are appended to `~/.otto/prompt_history/<hash>.jsonl`
...
pub struct PromptHistory {
    ...
    entries: Vec<String>,
    /// `~/.otto/prompt_history/<hash>.jsonl`. `None` when `$HOME` is
...
/// `~/.otto/prompt_history/<hash>.jsonl`, where `<hash>` is the
