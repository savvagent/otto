...
//! plugin state in response to [`otto_plugin::HostEvent::HostStarting`].
//!
...
const RELEASES_API_URL: &str = "https://api.github.com/repos/savvagent/otto/releases/latest";
...
/// caller cohort.
const USER_AGENT: &str = concat!("otto-rs/", env!("CARGO_PKG_VERSION"), " (self-update)");
