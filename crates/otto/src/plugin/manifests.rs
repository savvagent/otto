...
mod tests {
    ...
    use otto_plugin::{Contributions, Manifest, Plugin, PluginKind};
    ...
    async fn keybinding_conflict_is_hard_error() {
        use otto_plugin::{Effect, KeyCodePortable, KeyEventPortable, KeyMods};
...
mod tool_summary_index_tests {
    ...
    use crate::plugin::registry::PluginRegistry;
    use async_trait::async_trait;
    use otto_plugin::{Contributions, Manifest, Plugin, PluginKind, ToolSummarySpec};
...
mod content_renderer_index_tests {
    ...
    use crate::plugin::registry::PluginRegistry;
    use async_trait::async_trait;
    use otto_plugin::{ContentRendererSpec, Contributions, Manifest, Plugin, PluginKind};
