...
pub use otto_protocol::ProviderId;
...
/// [`otto_protocol::ListModelsResponse::models`] at host bring-up and
...
pub enum ScreenArgs {
    ...
    /// staging directory the modal moves into `~/.otto/plugins/`
...
mod tests {
    ...
    fn provider_id_new_rejects_uppercase() {
        // ProviderId now lives in otto-protocol; its error type is
