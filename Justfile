# Build the wasm fixtures used by `cargo test -p otto-plugin-wasm`.
#
# Requirements:
...
# `crates/otto-plugin-wasm/tests/fixtures/*.wasm` and committed to the
...
build-fixture-static:
    ...
    cp crates/otto-plugin-wasm/tests/fixtures-src/static/target/wasm32-unknown-unknown/release/fixture_static.wasm \
...
build-fixture-interactive:
    cd crates/otto-plugin-wasm/tests/fixtures-src/interactive && \
        cargo component build --target wasm32-unknown-unknown --release
    cp crates/otto-plugin-wasm/tests/fixtures-src/interactive/target/wasm32-unknown-unknown/release/fixture_interactive.wasm \
       crates/otto-plugin-wasm/tests/fixtures/interactive.wasm
...
build-fixture-provider:
    cd crates/otto-plugin-wasm/tests/fixtures-src/provider && \
        cargo component build --target wasm32-unknown-unknown --release
    cp crates/otto-plugin-wasm/tests/fixtures-src/provider/target/wasm32-unknown-unknown/release/fixture_provider.wasm \
       crates/otto-plugin-wasm/tests/fixtures/provider.wasm
...
build-fixture-trap:
    cd crates/otto-plugin-wasm/tests/fixtures-src/trap && \
        cargo component build --target wasm32-unknown-unknown --release
    cp crates/otto-plugin-wasm/tests/fixtures-src/trap/target/wasm32-unknown-unknown/release/fixture_trap.wasm \
       crates/otto-plugin-wasm/tests/fixtures/trap.wasm

# Build the timeout-fault fixture and copy to tests/fixtures/timeout.wasm.
build-fixture-timeout:
    cd crates/otto-plugin-wasm/tests/fixtures-src/timeout && \
        cargo component build --target wasm32-unknown-unknown --release
    cp crates/otto-plugin-wasm/tests/fixtures-src/timeout/target/wasm32-unknown-unknown/release/fixture_timeout.wasm \
       crates/otto-plugin-wasm/tests/fixtures/timeout.wasm

# Build the denied-host fault fixture and copy to
# tests/fixtures/denied-host.wasm.
build-fixture-denied-host:
    cd crates/otto-plugin-wasm/tests/fixtures-src/denied-host && \
        cargo component build --target wasm32-unknown-unknown --release
    cp crates/otto-plugin-wasm/tests/fixtures-src/denied-host/target/wasm32-unknown-unknown/release/fixture_denied_host.wasm \
       crates/otto-plugin-wasm/tests/fixtures/denied-host.wasm

# Build the denied-account fault fixture and copy to
# tests/fixtures/denied-account.wasm.
build-fixture-denied-account:
    cd crates/otto-plugin-wasm/tests/fixtures-src/denied-account && \
        cargo component build --target wasm32-unknown-unknown --release
    cp crates/otto-plugin-wasm/tests/fixtures-src/denied-account/target/wasm32-unknown-unknown/release/fixture_denied_account.wasm \
       crates/otto-plugin-wasm/tests/fixtures/denied-account.wasm
