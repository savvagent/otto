...
- [ ] Run `cargo test -p savvagent --lib ui::tests` (or the narrowest exact test selector covering the new `ui.rs` footer tests) and expect the new/updated footer tests to pass.
