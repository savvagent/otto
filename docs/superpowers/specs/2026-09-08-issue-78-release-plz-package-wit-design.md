...
- If the sibling `../otto-plugin-wit/wit/` directory does not exist, `build.rs` must treat that as the expected packaged verification case and skip the comparison instead of failing.
